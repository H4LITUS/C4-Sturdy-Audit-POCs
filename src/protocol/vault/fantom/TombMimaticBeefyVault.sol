...
contract TombMimaticBeefyVault is GeneralVault {
    ...
    function processYield() external override onlyYieldProcessor {
        ...
        (uint256 yieldTOMB, uint256 yieldMIMATIC) =
            _withdrawLiquidityPool(TOMB_MIMATIC_LP, yieldTOMB_MIMATIC_LP);
        ...
        returns (uint256 amountTOMB, uint256 amountMIMATIC)
    {
        ...
        uint256 minTotalPrice = _amount.mul(
            oracle.getAssetPrice(_addressesProvider.getAddress("mooTombTOMB-MIMATIC"))
        ...
        uint256 minTombAmountFromPrice =
            minTotalPrice.div(oracle.getAssetPrice(_addressesProvider.getAddress("TOMB")));
    ...
    function pricePerShare() external view override returns (uint256) {
        return
            IBeefyVault(_addressesProvider.getAddress("mooTombTOMB-MIMATIC")).getPricePerFullShare();
    }
