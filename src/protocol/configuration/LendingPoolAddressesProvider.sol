 ...
 * @dev Main registry of addresses part of or connected to the protocol, including permissioned
 * roles
 * - Acting also as factory of proxies and admin of those, so with right to change its
 * implementations
...
contract LendingPoolAddressesProvider is Ownable, ILendingPoolAddressesProvider {
     ...
     * through delegateCall within the LendingPool contract, the proxy contract pattern does not
     * work properly hence
    ...
    /**
     * @dev Internal function to update the implementation of a specific proxied component of the
     * protocol
