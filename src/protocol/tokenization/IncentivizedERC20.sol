...
abstract contract IncentivizedERC20 is Context, IERC20, IERC20Detailed {
     ...
     * Done this way in order to not break compatibility with previous versions of
     * aTokens/debtTokens
     *
     */
    ...
    /**
     * @dev Executes a transfer of token from sender to recipient, if _msgSender() is allowed to do
     * so
