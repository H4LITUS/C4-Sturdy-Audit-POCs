    ...
    IAToken
{
     ...
     * @param underlyingAsset The address of the underlying asset of this aToken (E.g. WETH for
     * aWETH)
    ...
    /**
     * @dev Burns aTokens from `user` and sends the equivalent amount of underlying to
    ...
    function mintToTreasury(uint256 amount, uint256 index) external override onlyLendingPool {
        ...
        // The amount to mint can easily be very small since it is a fraction of the interest
        // ccrued.
    ...
    /**
     * @dev Transfers aTokens in the event of a borrow being liquidated, in case the liquidators
     * reclaims the aToken
     * - Only callable by the LendingPool
    ...
    /**
     * @dev Calculates the balance of the user: principal balance + interest generated by the
     * principal
    ...
    function _getIncentivesController()
        ...
        view
        override
        returns (ISturdyIncentivesController)
    {
