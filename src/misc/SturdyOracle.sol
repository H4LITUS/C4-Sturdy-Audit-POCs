...
/// @notice Proxy smart contract to get the price of an asset from a price source, with Chainlink
/// Aggregator
...
contract SturdyOracle is IPriceOracleGetter, Ownable {
    ...
    /// @notice External function called by the Sturdy governance to set or replace sources of
    /// assets
    /// @param assets The addresses of the assets
    /// @param sources The address of the source of each asset
