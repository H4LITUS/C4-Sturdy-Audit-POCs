...
contract YearnBOOVault is GeneralVault {
        ...
        returns (uint256)
    {
        ...
        // Withdraw from Yearn Vault and receive BOO
        uint256 assetAmount =
            IYearnVault(_addressesProvider.getAddress("YVBOO")).withdraw(_amount, address(this), 1);
    ...
    function _convertAndDepositYield(address _tokenOut, uint256 _booAmount) internal {
        ...
        uint256 minAmountFromPrice = _booAmount.mul(
        ...
        uint256[] memory receivedAmounts = IUniswapV2Router02(uniswapRouter)
            ...
            _booAmount, minAmountFromPrice, path, address(this), block.timestamp
        );
    ...
    function _processTreasury(uint256 _yieldAmount) internal returns (uint256) {
        ...
        IERC20(_addressesProvider.getAddress("YVBOO")).safeTransfer(
