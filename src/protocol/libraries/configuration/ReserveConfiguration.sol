...
library ReserveConfiguration {
    ...
    uint256 constant MAX_VALID_LTV = 65_535;
    uint256 constant MAX_VALID_LIQUIDATION_THRESHOLD = 65_535;
    uint256 constant MAX_VALID_LIQUIDATION_BONUS = 65_535;
    uint256 constant MAX_VALID_DECIMALS = 255;
    uint256 constant MAX_VALID_RESERVE_FACTOR = 65_535;
    ...
    function setCollateralEnabled(
        ...
        pure
    {
        self.data = (self.data & COLLATERAL_MASK)
     ...
     * @param self The reserve configuration
     * @return The state flags representing active, frozen, borrowing enabled, stableRateBorrowing
     ...
     * @param self The reserve configuration
     * @return The state params representing ltv, liquidation threshold, liquidation bonus, the
     * reserve decimals
     *
     */
