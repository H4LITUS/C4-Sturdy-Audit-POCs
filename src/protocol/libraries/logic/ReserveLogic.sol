...
library ReserveLogic {
     ...
     * A value of 2*1e27 means that for each unit of debt, one unit worth of interest has been
     * accumulated
     * @param reserve The reserve object
    ...
    /**
     * @dev Accumulates a predefined amount of asset to the reserve as a fixed, instantaneous
     * income. Used for example to accumulate
    ...
    /**
     * @dev Updates the reserve current stable borrow rate, the current variable borrow rate and the
     * current liquidity rate
     * @param reserve The address of the reserve to be updated
     * @param liquidityAdded The amount of liquidity added to the protocol (deposit or repay) in the
     * previous action
        ...
        internal
    {
        ...
        (vars.newLiquidityRate, vars.newStableRate, vars.newVariableRate) =
    ...
    /**
     * @dev Mints part of the repaid interest to the reserve treasury as a function of the
     * reserveFactor for the
     * specific asset.
     * @param reserve The reserve reserve to be updated
     * @param scaledVariableDebt The current scaled total variable debt
     * @param previousVariableBorrowIndex The variable borrow index before the last accumulation of
     * the interest
     * @param newLiquidityIndex The new liquidity index
     * @param newVariableBorrowIndex The variable borrow index after the last accumulation of the
     * interest
     *
     */
        ...
        internal
    {
        ...
        vars.cumulatedStableInterest = MathUtils.calculateCompoundedInterest(
            vars.avgStableRate, vars.stableSupplyUpdatedTimestamp, timestamp
        );

        vars.previousStableDebt = vars.principalStableDebt.rayMul(vars.cumulatedStableInterest);

        //debt accrued is the sum of the current debt minus the sum of the debt at the last update
        vars.totalDebtAccrued = vars.currentVariableDebt.add(vars.currentStableDebt).sub(
