...
contract YearnLINKVault is GeneralVault {
        ...
        returns (uint256)
    {
        ...
        // Withdraw from Yearn Vault and receive LINK
        uint256 assetAmount =
            IYearnVault(_addressesProvider.getAddress("YVLINK")).withdraw(_amount, address(this), 1);
    ...
    function _convertAndDepositYield(address _tokenOut, uint256 _linkAmount) internal {
        ...
        uint256 minAmountFromPrice = _linkAmount.mul(
        ...
        uint256[] memory receivedAmounts = IUniswapV2Router02(uniswapRouter)
            ...
            _linkAmount, minAmountFromPrice, path, address(this), block.timestamp
        );
    ...
    function _processTreasury(uint256 _yieldAmount) internal returns (uint256) {
        ...
        IERC20(_addressesProvider.getAddress("YVLINK")).safeTransfer(
