...
contract StableDebtToken is IStableDebtToken, DebtTokenBase {
        ...
        returns (bool)
    {
        ...
        vars.newStableRate = _usersStableRate[onBehalfOf].rayMul(currentBalance.wadToRay()).add(
    ...
    function burn(address user, uint256 amount) external override onlyLendingPool {
        ...
        if (previousSupply <= amount) {
            ...
            if (secondTerm >= firstTerm) {
                ...
                newAvgStableRate =
                    _avgStableRate = firstTerm.sub(secondTerm).rayDiv(nextSupply.wadToRay());
            }
        }
        ...
        if (balanceIncrease > amount) {
            ...
            emit Burn(
                user, amountToBurn, currentBalance, balanceIncrease, newAvgStableRate, nextSupply
            );
        }
    ...
    /**
     * @dev Returns the principal and total supply, the average borrow rate and the last supply
     * update timestamp
     *
     */
