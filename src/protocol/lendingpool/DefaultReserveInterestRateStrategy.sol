 ...
 * - An instance of this same contract, can't be used across different Sturdy markets, due to the
 * caching
...
contract DefaultReserveInterestRateStrategy is IReserveInterestRateStrategy {
    ...
    /**
     * @dev this constant represents the utilization rate at which the pool aims to obtain most
    ...
    /**
     * @dev This constant represents the excess utilization rate above the optimal. It's always
     * equal to
    ...
    // Slope of the stable interest curve when utilization rate > 0 and <= OPTIMAL_UTILIZATION_RATE.
    // Expressed in ray
    uint256 internal immutable _stableRateSlope1;

    // Slope of the stable interest curve when utilization rate > OPTIMAL_UTILIZATION_RATE. Expressed
    // in ray
     ...
     * @param reserveFactor The reserve portion of the interest that goes to the treasury of the
     * market
    ...
    /**
     * @dev Calculates the interest rates depending on the reserve's state and configurations.
     * NOTE This function is kept for compatibility with the previous DefaultInterestRateStrategy
     * interface.
        ...
        returns (uint256, uint256, uint256)
    {
        ...
        return (
            vars.currentLiquidityRate, vars.currentStableBorrowRate, vars.currentVariableBorrowRate
        );
    }
     ...
     * @param currentAverageStableBorrowRate The current weighted average of all the stable rate
     * loans
