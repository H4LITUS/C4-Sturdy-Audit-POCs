...
import { InitializableImmutableAdminUpgradeabilityProxy } from
    "../libraries/sturdy-upgradeability/InitializableImmutableAdminUpgradeabilityProxy.sol";
...
contract LendingPoolConfigurator is VersionedInitializable, ILendingPoolConfigurator {
    ...
    function updateStableDebtToken(UpdateDebtTokenInput calldata input) external onlyPoolAdmin {
        ...
        _upgradeTokenImplementation(
            reserveData.stableDebtTokenAddress, input.implementation, encodedCall
        );

        emit StableDebtTokenUpgraded(
            input.asset, reserveData.stableDebtTokenAddress, input.implementation
        );
    }
     ...
     * @param stableBorrowRateEnabled True if stable borrow rate needs to be enabled by default on
     * this reserve
     *
     */
     ...
     * all the values are expressed in percentages with two decimals of precision. A valid value is
     * 10000, which means 100.00%
     * @param asset The address of the underlying asset of the reserve
     * @param ltv The loan to value of the asset when used as collateral
     * @param liquidationThreshold The threshold at which loans using this asset as collateral will
     * be considered undercollateralized
     * @param liquidationBonus The bonus liquidators receive to liquidate this asset. The values is
     * always above 100%. A value of 105%
        ...
        returns (address)
    {
        ...
        new InitializableImmutableAdminUpgradeabilityProxy(
        address(this)
      );
