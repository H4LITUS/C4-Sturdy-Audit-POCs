...
library GenericLogic {
     ...
     * (i.e. doesn't bring the user borrow position health factor under
     ...
     * @return The total collateral and total debt of the user in ETH, the avg ltv, liquidation
     * threshold and the HF
     *
     */
    ...
    /**
     * @dev Calculates the equivalent amount in ETH that an user can borrow, depending on the
     * available collateral and the
