...
contract YearnSPELLVault is GeneralVault {
    ...
    function _convertAndDepositYield(address _tokenOut, uint256 _spellAmount) internal {
        ...
        uint256 minAmountFromPrice = _spellAmount.mul(
        ...
        uint256[] memory receivedAmounts = IUniswapV2Router02(uniswapRouter)
            ...
            _spellAmount, minAmountFromPrice, path, address(this), block.timestamp
        );
    ...
    function _processTreasury(uint256 _yieldAmount) internal returns (uint256) {
        ...
        IERC20(_addressesProvider.getAddress("YVSPELL")).safeTransfer(
